...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/commdity/commodity/">commdity列表</a></li>
		<shiro:hasPermission name="commdity:commodity:edit"><li><a href="${ctx}/commdity/commodity/form">commdity添加</a></li></shiro:hasPermission>
	</ul>
		...
		<c:forEach items="${page.list}" var="commodity">
			<tr>
				...
				<shiro:hasPermission name="commdity:commodity:edit"><td>
					...
					<a href="${ctx}/commdity/commodity/delete?id=${commodity.id}" onclick="return confirmx('确认要删除该commdity吗？', this.href)">删除</a>
