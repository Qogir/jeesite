...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/manager/order/">订单管理列表</a></li>
		<li class="active"><a href="${ctx}/manager/order/form?id=${order.id}">订单管理<shiro:hasPermission name="manager:order:edit">${not empty order.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="manager:order:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="order" action="${ctx}/manager/order/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="manager:order:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
