...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/track/commodity/">订单物流进度列表</a></li>
		<li class="active"><a href="${ctx}/track/commodity/form?id=${commodity.id}">订单物流进度<shiro:hasPermission name="track:commodity:edit">${not empty commodity.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="track:commodity:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="commodity" action="${ctx}/track/commodity/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="track:commodity:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
